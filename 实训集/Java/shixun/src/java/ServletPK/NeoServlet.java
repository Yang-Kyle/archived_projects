...
public class NeoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            sess01.setAttribute("UserDis",User);
            sess02.setAttribute("PassDis",Pass);
            // out.println("UserDis");
            // sess.getAttribute("UserDis")
            if ("".equals(User)) {
                out.println("用户名不能为空！");
            }
            if ("".equals(Pass)) {
                ...
                if ("Admin".equals(User) && "root".equals(Pass)) {
                    ...
                    rd.include(req, resp);
                    out.println("<html><head><title>Servlet SignIn</title></head><body><h1>"+User+"登录成功!" + "</h1></body></html>");
                }
            }
        } finally {
            out.close();

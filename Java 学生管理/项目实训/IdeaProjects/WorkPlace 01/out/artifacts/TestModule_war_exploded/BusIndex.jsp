...
<div id="box">
    <div class="box">
        <a href="BusIndex.jsp">校园一卡通系统</a>
    </div>
</div>
<br/>
<%--标签库测试--%>
<c:out value="商家您好 您已进入商家版界面"></c:out>
<h1 style="text-align:center">商家登录</h1>
<div class="nav">
    <blockquote class="style01">
        <form action="Business.jsp" method="get">
            <%--                 页面测试 项目发布请改成POST！！！！！      --%>
...
<%--                </option>--%>
            ...
            <p>&nbsp;&nbsp;&nbsp;<input style="display:inline-block" type="submit"
                                        value="&nbsp;登录&nbsp;"/>
                <a href="BusSignUp.jsp" style="display:inline-block">
                    <font style="color:blue;font-size:12px;display:inline-block">我还没号?>&nbsp;
                    </font>
                </a></p>
                <a href="index.jsp" style="display:inline-block">
                    <font style="color:blue;font-size:12px;display:inline-block">进入学生版界面>>&nbsp;
                    </font>
                </a>
        </form>

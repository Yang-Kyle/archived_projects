...
public class StuSignUp extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // INSERT
        StuM = new StuMessage(null, userName, password);
        result = dao.add(StuM);
        // 响应写入
        out = resp.getWriter();
        if (result == 1) { // 火狐可能出不来样式 建议删了火狐（bushi 推荐linux或者win server运行
            out.println("<center>恭喜" + req.getParameter("userName") + "同学!!<br/>(点击即可返回)<br/>" +
                    "<a href='index.jsp' style='text-decoration:none'><font style='color:green;font-size:36'><br/>会员账号订阅成功！</font></a></center><br/>");
        } else {
            out.println("<a href='index.jsp'><font style=‘color:red;font-size:36'>你在干婶么？</font></a><br/>");
        }

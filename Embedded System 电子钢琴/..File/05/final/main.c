...

{
    ...
    lcd_draw_jpeg(0, 0, "bar.jpg", NULL, 0, 1);

    

    for (int i = 0; i < 12; i++) {

        lcd_draw_jpeg(10+i*65, 47, "key_off.jpg", NULL, 0, 1);

    }



    lcd_draw_jpeg(230, 404, "logo.jpg", NULL, 0, 1);
    ...
    while (1) {
        ...
        if (i < 12) {        
            ...
            if (new_flag != 13) {
                ...
                lcd_draw_jpeg(10+65*old_flag, 47, "key_off.jpg", NULL, 0, 1);

            }



            if (x >= 10+65*new_flag && x < 75+65*new_flag && y >= 47 && y < 327) {

                lcd_draw_jpeg(10+65*new_flag, 47, "key_on.jpg", NULL, 0, 1);
			...
			if (x >= 10 && x < 790 && y >= 47 && y < 327) {
                ...
                pthread_create(&music_tid, NULL, play_music, (void*)&a);
